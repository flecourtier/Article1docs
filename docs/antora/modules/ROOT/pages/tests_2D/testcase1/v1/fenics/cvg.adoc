...
[cols="a,a"]
|===
|image::{cvg_dir}fem/FEM_case1_param1.png[width=420.0,height=340.0]
|image::{cvg_dir}fem/FEM_case1_param2.png[width=420.0,height=340.0]
|===
...
[cols="a,a"]
|===
|image::{cvg_dir}add/Corr_case1_param1.png[width=420.0,height=340.0]
|image::{cvg_dir}add/Corr_case1_param2.png[width=420.0,height=340.0]
|===
...
[cols="a,a"]
|===
|image::{cvg_dir}fem-add/FEM-Corr_case1_param1.png[width=420.0,height=340.0]
|image::{cvg_dir}fem-add/FEM-Corr_case1_param2.png[width=420.0,height=340.0]
|===
...
image::{cvg_dir}add/Corr_case1_param1_degreePINNs.png[width=420.0,height=340.0]
...
image::{cvg_dir}fem-add/FEM-Corr_case1_param1_analyse.png[width=420.0,height=340.0]