...
image::{cvg_dir}fem/FEM_case4_v3_param1.png[width=420.0,height=340.0]

**Convergence obtenue pour la Correction :**

image::{cvg_dir}add/Corr_case4_v3_param1.png[width=420.0,height=340.0]

**Sur le même graphique :** 

image::{cvg_dir}fem-add/FEM-Corr_case4_v3_param1.png[width=420.0,height=340.0]
